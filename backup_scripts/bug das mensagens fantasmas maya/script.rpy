...
label conversa_maya:
    if persistent.enzo_derrotado and not msg_enzo_derrotado_lida:
        ...
        # Usamos renpy.random.choice para o sorteio ser compatível com o Save do jogo
        $ msg_para_celular = renpy.random.choice(respostas_maya)
        
        # Remove a notificação (bolinha vermelha) do HUB
        $ nova_msg_maya = False
        
        # Chama a sua tela de celular com a frase sorteada
