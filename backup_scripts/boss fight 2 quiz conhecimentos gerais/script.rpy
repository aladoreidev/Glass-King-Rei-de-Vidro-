...
init python:
    ...
    puzzles_xadrez = {
        "Quantas casas tem um tabuleiro de xadrez?": 
            ["32 casas", "64 casas", "81 casas", 1],
        
        "Qual destas NÃO é uma abertura oficial de xadrez?": 
            ["Defesa Siciliana", "Abertura Italiana", "Gambito do Cavalo Saltitante", 2],
        
        "Qual o nome popular do mate que ocorre em apenas 4 jogadas?": 
            ["Mate do Pastor", "Mate do Louco", "Mate do Corredor", 0],
            
        "Qual é a única peça que pode pular por cima das outras?": 
            ["Bispo", "Rainha", "Cavalo", 2],

        "Quantos peões cada jogador tem no início da partida?": 
            ["6 peões", "8 peões", "10 peões", 1],

        "O Rei pode se mover para uma casa que está sendo atacada?": 
            ["Sim, se ele capturar a peça", "Não, nunca", "Apenas no Roque", 1],

        "Qual destas peças tem maior valor relativo em pontos?": 
            ["Torre", "Bispo", "Rainha", 2],

        "O que acontece se um Rei ficar sem movimentos legais mas não estiver em xeque?": 
            ["Vitória", "Derrota", "Empate (Afogado)", 2],

        "Em que casa a Rainha Branca deve começar o jogo?": 
            ["Casa Branca", "Casa Preta", "Tanto faz", 0],

        "Como se chama o movimento especial envolvendo o Rei e a Torre?": 
            ["En Passant", "Promoção", "Roque", 2]
    }
