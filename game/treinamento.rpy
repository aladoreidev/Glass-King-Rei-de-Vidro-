...
#     window hide # <--- ADICIONE ISSO AQUI PARA SUMIR A BARRA VAZIA
    
#     jump abrir_hub


# ==============================================================================
# 2. DEFINIÇÃO DE ESTILOS (Ajustado para centralização perfeita)
# ==============================================================================
style hub_button:
    background Frame(Solid("#2c3e50cc"), 4, 4) 
    padding (20, 15)
    hover_background Solid("#3498db") 
    xminimum 300 
    text_align 0.5 # Garante que o texto fique no meio do botão
...
# ==============================================================================
# 4. LÓGICA DO JOGO (Corrigida e simplificada para não dar erro)
# ==============================================================================
label hub_treinar:
    $ acertos = 0
    $ total_puzzles = 5
    ...
    python:
        for puzzle in treino_do_dia:
            ...
            # Mostra o feedback (O Ren'Py cuida da janela aqui)
            if resultado:
                renpy.say(t, "Boa! Acertei essa.")
                acertos += 1
            else:
            ...
            # Esta é a forma correta de esconder a janela via Python se quiser:
    ...
    window hide # Limpa a barra antes de voltar ao hub
    jump abrir_hub