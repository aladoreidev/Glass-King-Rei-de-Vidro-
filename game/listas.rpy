...
# --- A LISTA MESTRA ATUALIZADA ---
default lista_torneios = [
    # Nome, Rating Req, Label Alvo, Var_Vitoria, Var_Historia
    ("Magnum Chess Masters", 0, "boss_fight_enzo", "enzo_vencido", "hist_magnum"),
    ("Desafio da Luísa", 1000, "boss_fight_luisa", "luisa_vencida", "hist_luisa"),
    ("Torneio Ala do Rei", 1200, "cena_torneio_ala_do_rei", "copa_local_vencida", "hist_ala_rei"),
    ("Regional Amador", 1400, "regional_amador", "regional_vencido", "hist_regional"),
    ("Aberto da Cidade", 1600, "aberto_cidade", "aberto_cidade_vencido", "hist_aberto"),
    ("Estadual Sub-20", 1800, "estadual_sub20", "estadual_vencido", "hist_estadual"),
    ("Memorial dos Mestres", 2000, "memorial_mestres", "memorial_vencido", "hist_memorial"),
    ("Campeonato Nacional", 2200, "nacional", "nacional_vencido", "hist_nacional"),
    ("Seletiva Internacional", 2400, "seletiva_inter", "seletiva_vencido", "hist_seletiva"),
    ("Torneio dos Candidatos", 2600, "candidatos", "candidatos_vencido", "hist_candidatos"),
    ("Campeonato Mundial", 2800, "mundial", "mundial_vencido", "hist_mundial")
]
